...
class teamTests(TestCase):
    ...
    def test_list(self):
        ...
        self.assertContains(response, 'tbQueueIndex')
    ...
    def test_detail(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, '<a href="#">Queue Overview</a>')
        self.assertContains(response, 'Edit Queue')
        self.assertContains(response, 'Queue Members')
    ...
    def test_members(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, '<a href="#">Queue Members</a><')
    ...
    def test_create(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, 'frmQueueAdd')
    ...
    def test_edit(self):
        ...
        try:
            ...
            self.assertEqual(response.status_code, 200)
            self.assertContains(response, 'frmQueueEdit')
